...
export const projects: Project[] = [
  {
    ...
    description:
      "A pixel-accurate rebuild of a Framer template, translated into a fully responsive Next.js site — built to test how closely custom code could match a no-code design system in both fidelity and performance.",
    imageHeight: 520,
    category: "frontend",
    link: "https://launchfolio-rcr8.vercel.app",
  ...
  },
  {
    ...
    description:
      "A bright startup idea where users can create 5 aside football sessions with flexibility of time, location and skill level and others can join. Users also have the luxury of rating and reviewing each other after a kickabout session.",
    imageHeight: 520,
    category: "fullstack",
  ...
  },
  {
    ...
    description:
      "A furniture ecommerce site built from a designer-provided concept, with an editorial product presentation and a streamlined checkout experience.",
    imageHeight: 520,
    category: "frontend",
  ...
  },
  {
    ...
    image: OwnTheFit,
    images: [
      { src: OTF1, type: "mobile" },
      { src: OTF2, type: "mobile" },
      { src: OTF3, type: "mobile" },
      { src: OTF4, type: "mobile" },
      { src: OTF5, type: "mobile" },
      { src: OTF6, type: "mobile" },
      { src: OTF7, type: "mobile" },
      { src: OTF8, type: "mobile" },
      { src: OTF9, type: "mobile" },
      { src: OTF10, type: "mobile" },
    ],
    projectTitle: "OwnTheFit",
    link: "https://own-the-fit.vercel.app",
    description:
      "A social community meets Ecommerce web app for streetwear enthusiasts and designers to connect.",
    imageHeight: 520,
    category: "fullstack",
    projectType: "Web App",
    year: "2025",
